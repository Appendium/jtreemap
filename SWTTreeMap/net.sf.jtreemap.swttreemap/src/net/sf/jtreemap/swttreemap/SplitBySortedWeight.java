 ...
 *                     www.ObjectLab.co.uk
 *
 * $Id: SplitBySortedWeight.java 75 2006-10-24 23:00:51Z benoitx $
 * 
...
public class SplitBySortedWeight extends SplitStrategy {
  ...
  public void splitElements(List<TreeMapNode2> list, List<TreeMapNode2> group1,
    ...
    List<TreeMapNode2> listClone = new ArrayList<TreeMapNode2>(list);
    ...
    for (Iterator<TreeMapNode2> i = listClone.iterator(); i.hasNext();) {
